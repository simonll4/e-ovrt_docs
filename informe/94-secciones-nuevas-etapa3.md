...
> | **Comparación con modelo adaptado** (ajuste fino) | Condicionada, no ejercida | Excluida por **presupuesto de tiempo del proyecto**, no por indisponibilidad de datos ni de recursos: el conjunto de entrenamiento y la infraestructura de cómputo se encuentran disponibles. El protocolo comparativo queda especificado. |
