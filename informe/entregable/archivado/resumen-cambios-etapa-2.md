...
- ✎ **2026-08-31 — existe un PASE 3 (NO aplicado):**
  [`desarrollando/correcciones-etapa-2-pase-3.md`](../desarrollando/archivado/correcciones-etapa-2-pase-3.md)
...
## ✅ Cierre definitivo de la Etapa 2 — v1.15 (2026-09-03)

Este resumen documenta **v1.0 → v1.4**. Lo que siguió, en una tabla:

| Versión | Fecha | Qué la produjo | Acta |
|---|---|---|---|
| v1.5 | 08-31 | pase 4, legibilidad | `archivado/correcciones-etapa-2-pase-4.md` |
| v1.6 | 08-31 | pase 5, poda por aporte | `archivado/correcciones-etapa-2-pase-5.md` |
| v1.7 | 09-01 | pase 6, desacople normativo | `archivado/correcciones-etapa-2-pase-6.md` |
| v1.8 | 09-01 | cierre D-E1-11 (marcador AAIP borrado) | `archivado/cierre-d-e1-11-aaip.md` |
| v1.9 / v1.10 | 09-02 | §17.1.2 y §17.1.4 (GPT) · §17.1.5 de 21 a 4 subsecciones | `archivado/validacion-reestructuracion-17-1-5.md` |
| **v1.11** | 09-03 | **el usuario** reestructura §17.1.6 (19 → 5) y §17.1.7 (28 → 6) | — |
| v1.12 → v1.14 | 09-03 | reparaciones sobre la v1.11, como sugerencias | `archivado/relevamiento-17-1-v1-11.md` §H–§L |
| **v1.15 FINAL** | 09-03 | tramo §17.1.8–§17.1.11 sin subsecciones, Anexos C/D y mecánicos de §17.1.6 | `archivado/analisis-17-1-8-anexos.md` §8 |

**Resultado del ciclo completo, contra la v1.8** (medido con el mismo instrumento):

| | v1.8 | v1.15 |
|---|---:|---:|
| Palabras | 23.906 | **15.464** (−35,3 %) |
| Títulos | 109 | **37** (cero de nivel 5) |
| Tablas | 26 | **22** |
| Ecuaciones | 76 | **4** |
| Referencias citadas | 27 | **29** (cero bajas, dos altas) |

**Lo que no se perdió, con nombre:** el catálogo CR-01…CR-06 y su evaluabilidad · los patrones
PR-01…PR-06 con severidad, persistencia e histéresis · las cinco fases del protocolo · las cinco
reglas de decisión del ajuste al dominio · los cinco supuestos de interpretación con la frase
escudo ("una alerta no equivale a una sanción") · el pre-registro no ejercido (MOT17 y OVT-B,
templates, español, kappa, datos complementarios) · las siete condiciones de partición · las
reglas de instrumentación y lectura contra las que §17.5 declara sus resultados.

**Lo que cambió de forma y hay que saber al leer material viejo:** la numeración de subsecciones
([`desarrollando/mapa-secciones-17-1-v1-15.md`](../desarrollando/archivado/mapa-secciones-17-1-v1-15.md)), los
nombres de métrica ahora en texto plano, y los huecos de tablas 18, 19, 31 y 32 que resuelve la
integración.
