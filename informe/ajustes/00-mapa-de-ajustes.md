...
| **AJ-0.05** | §17.2 Costos asociados · §14.4 | EVIDENCIA | 🟡 | **Hueco abierto, no relevado.** Nadie contrastó todavía los costos declarados contra lo que efectivamente se gastó (hardware local, horas de GPU, el ≈1 GPU-h medido del dimensionamiento T1 del fine-tuning — jornada comprometida, ADR-017). Decidir si se actualiza o se declara sin cambios. | a relevar — insumo parcial en `operacion/100` §6 |
