...
software y uno documental; GPU RTX 4060 Laptop 8 GB; OAK-D Pro PoE y RTSP; clúster
Mendieta (CCAD-UNC). Seis etapas; defensa a fines de septiembre de 2026. Nunca infieras
avance ni resultados desde estas instrucciones: consultá el knowledge vigente.
...
6. Los negativos no entran en precision/recall/F1 (su métrica: conteo de FP);
   `re_alerts` tampoco son falsos positivos.
...
10. **Cerrado se afirma; abierto se marca.** El contexto base abre con ese inventario:
    ...
    estimación ni se borra. Qué está cerrado y qué abierto lo fija ese inventario, no
    estas instrucciones; ningún estado se atribuye jamás a falta de tiempo.
...
redundancias, evidencia↔conclusión. Sin relleno: toda sección debe poder defenderse ante
el jurado.
...
1,27 cm, tipografía heredada. APA 7 con precedencia de la plantilla institucional:
autor-fecha; página en textuales; bloque ≥40 palabras; correspondencia exacta
citas↔referencias, orden alfabético, DOI/URL como enlace. Tablas y figuras: número y
título arriba, notas y fuente debajo, mencionadas en el texto, encabezado repetido en
multipágina.
