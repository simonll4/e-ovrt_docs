...
> Generado el 2026-09-08. Etapa 2: seccion 17.1 (los Anexos C y D se corrigen aparte, D-E2-1).
...
- **Texto base = `90f` = §17.1 v1.15 FINAL (extraido 2026-09-03: 15.464 palabras, 37 titulos, 22 tablas, 4 ecuaciones, CERO marcas de revision), con los SEIS pases previos MAS el ciclo de reestructuracion del 09-01 al 09-03. **LA ETAPA 2 ESTA CERRADA — no reaplicar ningun pase.** Recorrido del ciclo: 17.1.2 y 17.1.4 (GPT, v1.9) · 17.1.5 de 21 a 4 subsecciones (v1.10) · 17.1.6 de 19 a 5 y 17.1.7 de 28 a 6 (el usuario, v1.11) · reparaciones sobre esa base (v1.12-v1.14: niveles de compromiso, modelo de presupuesto B/W, Anexo D citado y alineado con G2A desde el dequeue) · tramo 17.1.8-17.1.11 SIN subsecciones y anexos + mecanicos de 17.1.6 (v1.15). Contra la v1.8: -35,3 % de palabras, 109 -> 37 titulos, CERO bajas de referencias y dos altas (Milan et al. 2016 / Liang y Han 2024, a dar de alta en el listado global). **⚠ LA NUMERACION DE SUBSECCIONES CAMBIO: traducir toda unidad vieja con desarrollando/mapa-secciones-17-1-v1-15.md antes de aplicarla.** Los Anexos C y D viajan AL FINAL del propio .docx (D-P3-8) y la extraccion los incluye. Documento limpio, con UN comentario abierto del colega en 17.1.6 que la v1.15 ya responde con el registro de datasets. **Guardrails:** las metricas van en TEXTO PLANO en todo el capitulo (t_alert-system, t_G2A); sobreviven 4 objetos de ecuacion (2 definiciones por hitos + 2 del modelo de presupuesto), que se ven como ⟦ECUACIÓN⟧ y NO son erratas; CPN/EN/TN y las siglas t_alert-system/TTFD/SDR nacen aca y §17.3/§17.4 las usan — no renombrar.
- **Decisiones firmadas (2026-08-28):** D-E2-1 el .docx es SOLO §17.1 (Anexos C y D aparte, en 90g) · D-E2-2 los codigos E-DIR/E-IND/E-HYB se bautizan en §17.1.5.3 (v1.15) y §17.3.6.4 recorta su glosa a una remision · D-E2-5 el nivel intermedio 'estado observable por persona' se declara en §17.1.7.1 y §17.1.7.2 (AJ-2.13; era §17.1.7.3.1) · D-E2-6 MOT17/OVT-B y metricas MOT intactos con ⊘ explicito · D-E2-3 la regla 're-alerta ≠ FP' va en §17.1.7.3 (era §17.1.7.8.3) · D-E2-4 los 4.000/7.000 ms entran como decision dentro del rango de la Tabla 24, sin la palabra 'efectivos' · D-E2-7 marcador espejo de la AAIP en §17.1.11 (borrado el 09-01 al cerrarse D-E1-11) · D-E2-8 PODA-14 solo recorta §17.1.4. **Decisiones del pase 3 (2026-08-31):** D-P3-1 enmienda del guardrail 2 · D-P3-2 Tablas 17 y 22 fuera, renumeracion 16–36 (verificado: cero refs numericas aguas abajo) · D-P3-3 el fine-tuning en EBE se CONDICIONA a la adopcion conforme a §17.1.9, no se restringe a DBE (doctrina de la Tabla 28) · D-P3-4 la Tabla C.1 se queda en el Anexo C · D-P3-5 composicion final de anexos C 5→3 / D 6→3 · D-P3-6 la estimacion de latencia se mantiene (solo se parte el parrafo; la Tabla 21 corrige 50–250 → 35–250 por coherencia interna) · D-P3-7 el catalogo CR-01..CR-06 no se poda · D-P3-8 los Anexos C y D viajan AL FINAL del documento de la etapa (E2-49; supersede la mitad 'fuera del .docx' de D-E2-1) · **D-P3-9 VOZ DEL DOCUMENTO (criterio de casa, traido por el equipo desde la Etapa 1): lo que remite a una seccion que EXISTE deja de sonar 'a definir' y pasa a presente (E2-50, 12 sitios). EXCEPCIONES que NO se tocan: la prescripcion normativa del protocolo ('toda corrida debera declarar...', ~25 de los 41 'debera'), los 'podra' de permiso, los 'todavia' que dicen que ESTA instancia no decide, y sobre todo lo PRE-REGISTRADO Y NO EJERCIDO (MOT17/OVT-B, prompts en espanol, kappa, datos de CR-03/CR-04): decir que 'se define mas adelante' seria FALSO - lo reporta 17.5.** Medido: 15+16 tienen 7 sitios (pase del colega), 17.3 tiene 3, 17.4 y 17.5 CERO.**
...
## Fuente: `docs/informe/entregable/desarrollando/archivado/justificacion-extension-17-1.md`

> SHA-256 del bloque: `bc1ffe6864d00bfc37f0cf013b5f7dbcbcbb1309260f4032ea79a8b2c1d04863`  
> Seleccion: SUPERADO (2026-09-03) - se conserva como registro de la decision de entonces: explicaba por que 17.1 conservaba ~140 pag tras el pase 5 (v1.5/v1.6, ~26.000 palabras). El ciclo de reestructuracion 09-01/09-03 dejo el capitulo en 15.464 palabras y 37 titulos SIN perder tablas de pre-registro ni referencias, asi que la pregunta ya no se plantea. Lo que SIGUE rigiendo de aca es el criterio: lo no ejercido NO se borra y cero bajas de referencias.
...
> ciclo nuevo: `relevamiento-17-1-v1-11.md` (fuente: `docs/informe/entregable/desarrollando/archivado/relevamiento-17-1-v1-11.md`) y
> `analisis-17-1-8-anexos.md` (fuente: `docs/informe/entregable/desarrollando/archivado/analisis-17-1-8-anexos.md`).
...
> `analisis-poda-17-1.md` (fuente: `docs/informe/entregable/desarrollando/archivado/analisis-poda-17-1.md`) (el diagnóstico que originó la última poda) y
> al pase que la ejecuta (`correcciones-etapa-2-pase-5.md` (fuente: `docs/informe/entregable/desarrollando/archivado/correcciones-etapa-2-pase-5.md`)).
...
> SHA-256 del bloque: `2ee9f83666dc1b79780b6a837d49538ac4a0bdf27b4fc39a476e793340ee2ef2`  
> Seleccion: TEXTO BASE VIGENTE de la seccion 17.1: extraido el 2026-09-08 de la **v1.21**, la bajada de Google Docs con los pases 5, 5d y 5e ACEPTADOS por el usuario (el 5e reparo el parrafo vacio con estilo de titulo que habia quedado delante de 17.1.11 y el formato de ese titulo). 17.030 palabras contando los Anexos C y D (que viven AL FINAL del .docx), 37 titulos, 22 tablas, 4 ecuaciones, verificador OK, sin comentarios ni marcas de revision. **LA ETAPA 2 ESTA CERRADA — no reaplicar ningun pase.** Historia: SEIS pases + reestructuracion 09-01/09-03 (109 -> 37 titulos, -35,3 %, CERO bajas de referencias y dos altas: Milan et al. 2016 / Liang y Han 2024) + pases 5/5d (tres precisiones hacia atras: la regla de fuente unica se mantiene y §17.4.7 declara la desviacion; la particion de calibracion tiene semilla registrada; el banco temporal es 'material construido para ese fin'; Liu 2024; Tabla 26 'se orienta'). Ediciones del usuario del 09-08: 'Imp. probable' en la Tabla 35 y dos notas borradas. ⚠ **LA NUMERACION DE SUBSECCIONES CAMBIO en la v1.15**: toda acta anterior se traduce con desarrollando/mapa-secciones-17-1-v1-15.md. No cambiar una palabra de fondo sin un pase nuevo explicito. El 96b (v1.1) queda como foto historica fuera del paquete.
...
## Fuente: `docs/informe/entregable/desarrollando/mapa-secciones-17-1-v1-15.md`

> SHA-256 del bloque: `e3c807be64b3bed8a72206dbe5c3abb222582076c31f8c8d21656cbd5651b1f3`  
> Seleccion: MAPA DE TRADUCCION obligatorio (2026-09-03): la reestructuracion llevo §17.1 de 109 a 37 titulos, asi que TODA acta, ajuste o decision anterior cita subsecciones que ya no existen. Antes de aplicar cualquier unidad vieja sobre el .docx, traducir su numero con este mapa. Incluye ademas el estado de las tablas (22 vigentes, huecos 18/19 y 31/32 para la integracion) y los siete residuales que quedan para el pase de integracion al maestro. Las constancias completas del ciclo estan en desarrollando/archivado/ (relevamiento-17-1-v1-11.md §A-§L y analisis-17-1-8-anexos.md §0-§8).
...
> · texto extraído: `../90f-etapa2-texto-extraido.md` (fuente: `docs/informe/entregable/90f-etapa2-texto-extraido.md`).
...
> SHA-256 del bloque: `ee21a1c456f02b8402675a79c08f43f1813a79cf25903be48463806ae2f0f682`  
> Seleccion: HISTORICO (2026-09-03): la decision de que tablas quedaban en los Anexos C y D (5->3 y 6->3) y por que. Ya pegados y cerrados en la v1.15; las TRES notas del Anexo C se reescribieron alli (mas cortas, sin 'Fuente:', con remisiones vivas) y la C.2 dejo de estar huerfana: la cita 17.1.4.2. ⚠ toda la numeracion de secciones que este archivo cita CAMBIO (ver mapa-secciones-17-1-v1-15.md) y la 'Tabla 31' que menciona como vista de cobertura es hoy la Tabla 25. Sigue siendo la fuente para la mudanza a 19.3/19.4 en la integracion.
...
> `desarrollando/mapa-secciones-17-1-v1-15.md` (fuente: `docs/informe/entregable/desarrollando/mapa-secciones-17-1-v1-15.md`); (b) la
...
> Seleccion: dependencias inversas hacia la etapa 2: C-1 (bautismo E-DIR/E-IND/E-HYB, ahora firmado por D-E2-2), el solape 17.3.3.1/17.3.3.2 y la anomalia de la sigla OMML (hoy resuelta: la v1.15 usa texto plano en todo el capitulo).
...
> SHA-256 del bloque: `2b5a4661b355b82038aab879f2e17d7733d5fcba631f47704b7d08efc905529d`  
...
> `justificacion-extension-17-1.md` (fuente: `docs/informe/entregable/desarrollando/archivado/justificacion-extension-17-1.md`).
...
> `desarrollando/archivado/cierre-d-e1-11-aaip.md` (fuente: `docs/informe/entregable/desarrollando/archivado/cierre-d-e1-11-aaip.md`).
...
> `desarrollando/correcciones-etapa-2-pase-5.md` (fuente: `docs/informe/entregable/desarrollando/archivado/correcciones-etapa-2-pase-5.md`)
...
> `desarrollando/correcciones-etapa-2-pase-4.md` (fuente: `docs/informe/entregable/desarrollando/archivado/correcciones-etapa-2-pase-4.md`)
