...
> Generado el 2026-09-08. Etapa 1: secciones 15 y 16 (CERRADA 2026-08-28; el Anexo A corregido vive en 90e).
...
- **D-E1-11 quedo CERRADA el 2026-09-01** (decision del usuario, converge con el comentario C9 de la v1.1): el informe NO adjudica el tramite de inscripcion ante la AAIP — el parrafo de 'decision pendiente' y el marcador `[[PENDIENTE]]` de §16.6 **se BORRAN** en el proximo pase de esta etapa (el espejo de §17.1 ya esta borrado, v1.8). Las salvaguardas de §16.6 son el recaudo documentado; la respuesta sobre la inscripcion se prepara para la defensa. Constancia: desarrollando/cierre-d-e1-11-aaip.md.
...
> SHA-256 del bloque: `b962907eeb4affe75813b2fcd5141e0dedc0906d0677f80b643846a5c1750da2`  
> Seleccion: TEXTO BASE VIGENTE de las secciones 15 y 16: extraido el 2026-09-08 de la **v1.4** (bajada de Google Docs del 09-08 con el pase 5 ACEPTADO por el usuario; su contenido es identico al de la v1.3, solo cambio el numero): 18.750 palabras, 71 titulos numerados, verificador OK, el marcador [[PENDIENTE]] de la AAIP YA BORRADO (D-E1-11 cerrada). Trae los cinco pases E1, la revision del colega (v1.1, 09-01), la ronda del usuario (v1.2, 09-06) y el pase 5. **EN REVISION del colega en Google Docs**: 9 comentarios abiertos (2 del usuario y 7 de dos colegas; uno reabierto pide no nombrar CR-01/CR-02 en §15 antes de definirlos en §16) y 1 sugerencia del pase 5 sin resolver en §15.2 (esta extraccion la muestra como aceptada); un 'puede puede' en el parrafo sobre ajuste selectivo de capas que el usuario corrige alla. **SUPERA al 96c y al 96d.** El Anexo A y el listado de referencias siguen en `90e` (los arma el equipo para §19). **No redactar de nuevo ni cambiar una palabra de fondo**: cualquier cambio requiere un pase nuevo explicito.

# 90d — Texto extraído del documento de trabajo: §15 Estado del Arte y §16 Marco Teórico (v1.4, bajada del 2026-09-08; contenido idéntico a la v1.3, sólo cambió el número. EN REVISIÓN de los colegas: 9 comentarios abiertos y 1 sugerencia sin resolver)

> **Extracción derivada (2026-09-08)** del `.docx`
> `informe/entregable/E-OVRT-VDP_Secciones_15_y_16_Estado_del_Arte_y_Marco_Teorico_v1.4.docx`, **solo para búsqueda y cita**
