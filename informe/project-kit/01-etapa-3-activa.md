...
> Generado el 2026-09-08. Etapa 3: seccion 17.3, diseno arquitectonico.
...
> SHA-256 del bloque: `6f0f7b14e72d31e1f2fe56209cecb550e8d092a68e413f511716133f1be5e2f3`  
> Seleccion: TEXTO BASE VIGENTE de la seccion 17.3: extraido el 2026-09-08 de la **v1.12** (bajada del 09-08 con los pases 5 y 5d ACEPTADOS por el usuario; su contenido es identico al de la v1.11, solo cambio el numero; sin comentarios ni marcas): 14.208 palabras, 30 titulos, 14 tablas (39-52), 4 figuras, verificador OK. **LA ETAPA 3 ESTA CERRADA**: cuatro pases + ronda del usuario del 09-06 + pases 5/5d (la garantia del canal de alertas es el publicador, no el orden de arranque; planos <-> rutas de §16.5.3; una nota y dos sentidos restituidos). ⚠ El .docx arranca en 17.3.1 y NO trae el titulo '17.3. Diseño arquitectonico': se agrega al integrar. La numeracion de subsecciones cambio en la v1.6: traducir actas viejas con desarrollando/mapa-secciones-17-3-v1-6.md. No cambiar una palabra de fondo sin un pase nuevo explicito.
...
> SHA-256 del bloque: `2841c4a6713f2fae2de62b18f0c7712096619fd343d17a85d5fe3cc65fc8cd4c`  
