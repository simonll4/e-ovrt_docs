...
- **Contrastado contra:** los cuatro repos (`e-ovrt_media-plane`, `e-ovrt_control-plane`,
  ...
  operación 30–55.
- **Complementa (no reemplaza):** `nucleo/02-revision-critica-etapa3-y-norte.md` (crítica de julio 6,
  cuando casi nada de esto estaba construido) y `nucleo/08-alineacion-consolidacion-metodologica.md`.
