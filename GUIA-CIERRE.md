...
### 1. [ ] Ensayo con cámaras antes del rodaje (~1 hora, en tu casa)

**Qué es:** un ensayo *mecánico*, sin EPP ni actuación — probamos el circuito completo
(grabar una toma desde la consola → cortarla en clip; disparar la misma escena en vivo;
probar la claqueta) para que el día del rodaje no haya sorpresas.

**Detalle completo:** `docs/operacion/67-preparacion-rodaje-y-ebe.md`, sección **G2**.

> No necesitás casco ni chaleco para esto — de hecho, parate frente a cámara sin casco:
> deberías ver una alerta CR-01 real. Avisame cuándo tenés la hora y lo hacemos juntos.

---

### 2. [ ] Pasada humana en CVAT — los 14 videos de internet
...
### 3. [ ] Consentimientos + coordinar colegas + EPP físico
...
### 4. [ ] Ejecutar el rodaje (día completo, con tus colegas)
...
> Depende de 1, 2 y 3 de esta lista.
...
### 6. [ ] GT en CVAT del material del rodaje (después de grabar)

**Qué es:** la misma tarea que el punto 2, pero sobre las tomas del rodaje propio en vez de
...
Con el punto 2 (CVAT internet) ya alcanza para arrancar la Fase T. El resto de la cadena:

**T** (banco temporal) → **P** (validación de la plataforma) → **D** (E-DIR vs E-IND, si ya
está el punto 5) → análisis de errores → reporte de cierre.
