...
> ⚠️ **2026-08-10 — DOCUMENTO HISTÓRICO, y vale por no haberse actualizado.** Es el
> **diseño pre-registrado del experimento D1**, congelado **antes** de correrlo. Su valor
> metodológico es exactamente ese: actualizarlo con los resultados destruiría la prueba de
> que las hipótesis se fijaron de antemano. **No se toca.**
>
> Los resultados de D1 están en `e-ovrt_experimental-setup/results/clip_bench/` y el veredicto
> en `../../operacion/85`. Se complementa con `12`. Ver el `README.md` de esta carpeta.
