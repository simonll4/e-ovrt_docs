...
> ⚠️ **2026-08-10 — DOCUMENTO HISTÓRICO por ubicación, no por vigencia.** Sigue siendo **el
> diseño completo** del módulo (20 secciones: ledger, retry, dead-letter, canales, paridad
> DBE/EBE), y el módulo **no está implementado**, así que no hay nada a lo que
> "actualizarlo".
>
> **La entrada vigente es `../19`**, que consolida el ciclo de vida de la alerta y sus
> fronteras, y cita a este documento para el detalle. **Su §4 (ubicación del módulo) quedó
> superado por ADR-005** (repo propio). El estatuto del módulo lo fija **ADR-016**: trabajo
> comprometido, con el recorte de ADR-005 y E-06 excluida. Ver el `README.md` de esta
> carpeta.
