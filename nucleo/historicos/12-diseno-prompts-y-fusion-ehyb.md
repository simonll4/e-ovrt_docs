...
> ⚠️ **2026-08-10 — DOCUMENTO HISTÓRICO, y vale por no haberse actualizado.** Es la bajada
> operativa del **diseño pre-registrado de D1**, congelada junto con `04` **antes** de
> correr el experimento. Actualizarla con los resultados destruiría la prueba de
> pre-registro. **No se toca.**
>
> Los resultados están en `e-ovrt_experimental-setup/results/clip_bench/`. Ver el
