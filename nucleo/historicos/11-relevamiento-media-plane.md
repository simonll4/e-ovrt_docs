...
> ⚠️ **2026-08-10 — DOCUMENTO HISTÓRICO. No usar como estado del media-plane.**
> Reemplazado por **`../17-relevamiento-media-plane.md`**. Es la foto del 2026-07-09, y ya
> venía parchada por un banner del 07-18 que reconocía que varias afirmaciones habían
> quedado superadas — desde entonces pasó un mes más de desarrollo (rodaje, campañas del
> banco, blindaje EBE) que este documento no registra. Vale como registro de lo que se
> sabía ese día, y sus banners mandan sobre su cuerpo.
>
> Para el estado vigente: **`17`** (estructura, contratos, configuración y acople) y
> **`operacion/97`** (memoria de implementación y capacidades, relevada contra código el
> 2026-08-05).
