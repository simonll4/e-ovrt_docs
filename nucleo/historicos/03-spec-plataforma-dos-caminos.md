...
> ⚠️ **2026-08-10 — DOCUMENTO HISTÓRICO.** Spec previo a la implementación (última
> actualización 2026-07-09). Los dos caminos —DBE y EBE— **están construidos y
> ejercidos**. Para cómo quedaron: **`../14`** (mapa de la cadena) y `../../operacion/97`.
> Ver el `README.md` de esta carpeta.
...
- **Documentos que integra:**
  ...
  - `docs/informe/entregable/E-OVRT-VDP_Etapa_3_Diseno_Arquitectonico.docx` (Camino B en cada dimensión)
