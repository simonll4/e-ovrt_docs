...
| 67 | `operacion/67-preparacion-rodaje-y-ebe.md` | **⬅️ ESTADO VIGENTE DE PREPARACIÓN DEL RODAJE (reemplaza al 60 como punto de entrada operativo).** 5 gates: G1 (prompt set congelado), G3 (guion revisado), G4 (higiene de repos) — **CERRADOS**; único gate abierto: **G2, ensayo mecánico de doble toma con cámaras (~1h, necesita al usuario)**; G5 = checklist del día del rodaje. Consolida qué está verificado (grabación, EBE, campeón) vs qué falta. |
