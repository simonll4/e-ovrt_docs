...
| 45 | **distribución** — repo nuevo (`e-ovrt_alert-distribution`): bus control→distribución, `NotificationEnvelope`, ledger, canal MQTT, retry mínimo | repo nuevo | ADR-005 | **Escrito** → [45-distribucion-alertas.md](45-distribucion-alertas.md) |
