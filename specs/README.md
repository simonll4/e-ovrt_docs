...
| 45 | **distribución** — repo nuevo (`e-ovrt_alert-distribution`): bus control→distribución, `NotificationEnvelope`, ledger, canal MQTT, retry mínimo. ✎ 2026-08-18: **+§9 servicio HTTP** (`serve` en `:8082`, ADR-019, aditivo — CLI y subproceso intactos), implementado y verificado. ✎ 2026-08-19: **ADR-020** (2026-08-18) hizo de HTTP el **default** del runner y derogó ADR-018 — el subproceso quedó como fallback operativo | repo nuevo | ADR-005 · ADR-019 · ADR-020 | **Escrito** → [45-distribucion-alertas.md](45-distribucion-alertas.md) |
