...
| [005](adr-005-distribucion-mqtt-repo-propio.md) | Distribución recortada, canal MQTT, **repo propio** con bus control→distribución. ✎ 2026-08-10: **implementación comprometida** por ADR-016; *entre el 08-05 y el 08-10 estuvo declarada NO implementada por ADR-015 §2c, hoy derogada* | D5 | Aceptada — implementación comprometida (ADR-016) |
...
| [015](adr-015-cierre-de-alcance.md) | **Cierre de alcance al final del tramo experimental**: el alcance **creció** en E-03 (G1 pasa de demostrativa a capacidad operativa medida, F1 0,930 en 34/34), E-07 (OAK-D + EN-2 parcial) y E-13 (E-HYB-or ejecutada y refutada; `hyb_and` no ejecutada con causa); E-04 sigue no ejercida por secuenciación (✎ 2026-08-11: fila E-04 derogada por ADR-017 — se ejerce como jornada) y E-10 sigue "no aplicable" con fundamento medido. **Cierra la puerta**: no se agrega ninguna capacidad más, y la distribución MQTT queda declarada NO implementada (resuelve el condicional del ADR-005). Reescribe la lista de límites del capítulo — de los 8 ítems de R-13, **5 estaban resueltos**. **✎ 2026-08-10: §2b, §2c y §6 DEROGADOS por ADR-016; §2a, §3, §4 y §5 siguen vigentes** (la lista de límites L1–L8 se sigue citando desde §3) | doc 95 §5.1; desbloquea **R-13 y R-21** | **Aceptada** (usuario, 2026-08-05), **parcialmente derogada** (ADR-016, 2026-08-10) |
| [016](adr-016-reapertura-acotada-distribucion.md) | **Reapertura acotada**: se implementa la distribución de alertas con el recorte exacto de ADR-005 (un canal MQTT + `NotificationEnvelope` + ledger + retry mínimo + vista en la webconsole), para **cerrar la arquitectura** de la plataforma. E-06 sigue excluida y no se reabre nada más (✎ 2026-08-11: E-04 sale del freno por ADR-017). **La implementación no bloquea el informe**: el cierre arquitectónico lo entrega `nucleo/19`, y si el módulo no llega a tiempo se declara como estaba | Deroga ADR-015 §2b/§2c/§6; ratifica §2a/§3/§4/§5 | **Aceptada** (usuario, 2026-08-10) |
| [017](adr-017-fine-tuning-jornada-experimental.md) | **El fine-tuning (E-04) se ejerce** como jornada completa y nunca se atribuye su estado a falta de tiempo. **Adenda 2026-08-13:** F-100.1, freeze/smoke, dual gate, serving real y procedencia T-FT-023 están cerrados (snapshot tar `639e60df…`). Full sigue en NO-GO por D-FT-08/T-FT-005, evaluación T-FT-031 y baseline 26s T-FT-032; cero full. ✎ **2026-08-15: D-FT-08/T-FT-005, D-FT-12 y D-FT-13 firmadas, y T-FT-031/032 cerradas la misma jornada** (doc 120: baseline 26s one-shot ejecutada) — el NO-GO quedó en su último eslabón: `full-authorization.json` + `RUN` manual. La jornada no bloquea el informe | Deroga E-04 de ADR-016 (b) y ADR-015 §2a; el freno sigue para el resto | **Aceptada; implementación en curso** |
| [018](adr-018-acople-bff-subproceso-distribucion.md) | **Tercer patrón de acople: BFF-subproceso.** El runner de la webconsole lanza `eovrt-distribute` como proceso hijo local porque el repo de distribución es CLI, sin servicio HTTP; el dato sigue por el bus (`:5558`), lo nuevo es el control del ciclo de vida. Requisito vinculante: la consola dockerizada exige `EOVRT_DISTRIBUTION_EXECUTABLE`. No extiende el patrón a módulos futuros ni convierte el distribuidor en servicio | nueva (hueco de ADR-008/009) — promueve la nota del 08-14 | **Aceptada** (usuario, 2026-08-15) |
