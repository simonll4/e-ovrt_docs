...
| [017](adr-017-fine-tuning-jornada-experimental.md) | **El fine-tuning (E-04) se ejerce**: jornada experimental completa — escalera pre-registrada T1→T2/T3 con go/no-go (Tabla 37, `contingencia/20`), entrenamiento en Mendieta, evaluación contra `bench_v3`, y documentación de resultados **y limitaciones**. Encuadre del informe: **rama experimental condicionada por datos y protocolo desde el planteo inicial** (F-100.1, licencias, regla Tabla 37) — la causa "falta/presupuesto de tiempo" queda **prohibida**; el cómputo no es la restricción (≤1 GPU-h medido para T1). Las puertas técnicas del doc 100 §6 no se saltean, y la jornada **no bloquea el informe** (estado a la entrega, con causa técnica) | Deroga E-04 de ADR-016 (b) y de ADR-015 §2a; el freno sigue para el resto | **Aceptada** (usuario, 2026-08-11) |
